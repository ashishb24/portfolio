    ...
    return (
        ...
        >
            <path
                ...
                className="fill-light-accentColor dark:fill-dark-accentColor"
                opacity="0.15"
                id="path13"
            />
            <g id="tshirt">
            ...
            <g id="head">
                <g id="ccc">
                    <rect
                        ...
                        height="47"
                        width="27"
                        className="fill-light-skinColor dark:fill-dark-skinColor"
                        y="147.5"
                        x="105.5"
                    />
                </g>
                    ...
                    <g id="sides">
                        <g id="g59">
                            <path
                                ...
                                className="fill-light-dark dark:fill-dark-dark"
                            />
                        </g>
                        <g id="g63">
                            <path
                ...
                <g id="eyey2">
                    <circle id="circle113" r="5" cy="114" cx="98.4" className="fill-light-dark dark:fill-dark-dark" />
                    <circle id="circle115" r="5" cy="114" cx="136.9" className="fill-light-dark dark:fill-dark-dark" />
                </g>
            </g>
            <g id="shirt">
                <path
            ...
            <g id="legs">
                <g id="g188">
                    <path
                        ...
                        className="fill-light-avatarMisc dark:fill-dark-avatarMisc"
                    />
                </g>
                <g id="g192">
                    <path
                        ...
                        className="fill-light-avatarShoes bg-dark-avatarShoes"
                    />
                </g>
                <g id="g196">
                    <polygon
                    ...
                    <g id="g210">
                        ...
                        <g id="g208">
                            <path
                                ...
                                className="fill-light-imageDark dark:fill-dark-imageDark"
                            />
                        </g>
                    </g>
                    <g id="logobook">
                ...
                <g id="g222">
                    <path
                        ...
                        className="fill-light-imageClothes dark:fill-dark-imageClothes"
                    />
                </g>
                <g id="g226">
                    <path
